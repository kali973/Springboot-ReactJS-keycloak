        ...
        <Menu stackable>
            <Container>
                ...
                <Dropdown item text='Admin' style={getAdminMenuStyle()}>
                    <Dropdown.Menu>
                        <Dropdown.Item as={NavLink} exact to="/movies"
                                       onClick={checkAuthenticated}>Movies</Dropdown.Item>
                        <Dropdown.Item as={NavLink} exact to="/wizard" onClick={checkAuthenticated}>Movie
